...
export function HomePage({ onProductClick }: HomePageProps) {
  ...
  // Filter products by dynamic search query in real-time
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-32 md:pt-28">
      {/* Premium Swiggy-Style Hero Section (Dark Emerald / High-End Vibe) */}
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-950 via-[#051a09] to-black py-20 md:py-24 text-white -mt-32 md:-mt-28 mb-12 border-b border-gray-900 shadow-md">
        {/* Glow orbs */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#0c831f]/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#ffd400]/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center mt-6">
          ...
          >
            Curated premium gear. Discover best direct <span className="text-[#0c831f]">merchant deals</span>. noirkart it!
          </motion.h1>

          {/* Double-Input Search Bar */}
          <motion.div 
          ...
          >
            {/* Left part: Location/Category pin selector */}
            <div className="flex items-center gap-2.5 px-4 py-2 border-b md:border-b-0 md:border-r border-gray-100 w-full md:w-1/3 text-left relative cursor-pointer group select-none">
              <MapPin className="text-[#0c831f] flex-shrink-0" size={20} />
              <div className="flex-1 truncate">
                ...
                <div className="text-sm font-bold text-gray-700 flex items-center gap-1">
                  Delhi NCR, India
                  <span className="text-gray-400 group-hover:translate-y-0.5 transition-transform text-[10px]">▼</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 px-4 py-2 w-full md:w-2/3">
              ...
              <input
                type="text"
                placeholder="Search studio headphones, mechanical keyboards, premium watches..."
          ...
          {/* Floating showcase service cards (overlapping bottom edge of hero) */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-16 max-w-5xl">
            {[
              {
                title: "TECH SHOWCASE",
                subtitle: "CURATED AUDIO & SHACK",
                badge: "UP TO 40% OFF",
              ...
              <motion.div
                ...
                onClick={() => scrollToCategory(card.cat)}
              ...
              >
                <div className="text-left flex-1 pr-3 flex flex-col justify-between h-full">
                  <div>
                    <span className="text-[9px] bg-red-50 text-red-500 font-bold px-2 py-0.5 rounded-md uppercase tracking-wider inline-block mb-1.5">
                      {card.badge}
                    </span>
                  ...
                  {/* Green Arrow Button */}
                  <div className="w-8 h-8 rounded-full bg-[#0c831f] group-hover:bg-[#0a6b1a] text-white flex items-center justify-center transition-colors shadow-sm mt-4">
